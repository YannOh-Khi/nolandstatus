...
exports.start = function(SETUP) {
  ...
  const UpdateEmbed = function() {
    ...
    .setAuthor("⚡ NØ-LAND", "https://cdn.discordapp.com/attachments/828735259205959680/828737814216441867/Sans_titre_3.png")
    .setColor(0x722ea5)
    .setFooter(TICK_N % 2 === 0 ? '⚪ NØ-LAND ⚡' : '⚫ NØ-LAND ⚡')
    .setTimestamp(new Date())
    .addField('\n\u200b\nComment pouvez-vous nous rejoindre sur ⚡ NØ-LAND :','*Lancer FiveM ➔ F8 ➔* `connect ...`\n\u200b\n─────────────────────────────────────────────────',false)
    if (STATUS !== undefined)
    {
